...
Feature: Register
  ...
  Scenario: New account to register
    ...
    Examples:
      |emails             |tittle|fname |lname   |pass     |addres     |city      |state  |postcode|phone       |reffaddress|
      |cobatest@gmail.com |Mr    |Rahman|darmawan|123123123|pedongkelan|Los Angles|Alaska |13790   |087788119090|gas alan   |
